...
namespace apiplate.Migrations
{
    ...
    [Migration("20220703153339_addSubjectColumnToMessage")]
    partial class addSubjectColumnToMessage
    {
            ...
            modelBuilder.Entity("apiplate.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 7, 3, 17, 33, 38, 559, DateTimeKind.Local).AddTicks(6920),
                            Email = "almunzir99@gmail.com",
                            IsManager = true,
                            LastUpdate = new DateTime(2022, 7, 3, 17, 33, 38, 560, DateTimeKind.Local).AddTicks(7491),
                            PasswordHash = new byte[] { 57, 174, 130, 157, 123, 107, 98, 27, 171, 152, 71, 108, 116, 99, 198, 16, 40, 106, 87, 204, 66, 241, 68, 138, 70, 15, 178, 129, 164, 218, 59, 92, 142, 96, 171, 229, 140, 167, 138, 133, 247, 218, 57, 171, 135, 196, 195, 92, 73, 87, 2, 222, 183, 98, 85, 20, 64, 127, 9, 242, 63, 252, 83, 146 },
                            PasswordSalt = new byte[] { 14, 33, 235, 158, 86, 182, 220, 142, 245, 202, 153, 167, 81, 243, 89, 160, 145, 241, 128, 39, 15, 50, 181, 82, 187, 228, 139, 160, 114, 52, 146, 107, 77, 188, 5, 70, 77, 152, 36, 58, 45, 230, 73, 241, 128, 92, 192, 129, 9, 141, 35, 91, 6, 239, 243, 107, 213, 164, 31, 171, 159, 22, 229, 8, 156, 213, 228, 58, 195, 130, 182, 61, 45, 208, 58, 176, 195, 77, 66, 218, 64, 87, 212, 103, 62, 93, 210, 141, 120, 255, 206, 213, 2, 177, 59, 45, 246, 198, 31, 198, 52, 235, 32, 45, 25, 121, 118, 193, 191, 106, 111, 139, 100, 215, 219, 203, 86, 191, 210, 255, 238, 149, 244, 180, 248, 215, 231, 44 },
                            Phone = "249128647019",
                            Username = "almunzir99"
                        });
                });
