...
namespace apiplate.Migrations
{
    ...
    [Migration("20220727192537_addVolunteerTable")]
            ...
            modelBuilder.Entity("apiplate.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 7, 27, 21, 25, 36, 14, DateTimeKind.Local).AddTicks(8159),
                            Email = "almunzir99@gmail.com",
                            IsManager = true,
                            LastUpdate = new DateTime(2022, 7, 27, 21, 25, 36, 15, DateTimeKind.Local).AddTicks(7890),
                            PasswordHash = new byte[] { 49, 80, 80, 206, 252, 34, 97, 122, 117, 90, 51, 80, 180, 52, 138, 143, 219, 39, 215, 140, 211, 131, 252, 212, 42, 96, 176, 90, 135, 157, 31, 155, 0, 172, 251, 139, 158, 169, 221, 52, 249, 221, 120, 230, 97, 219, 192, 37, 98, 177, 147, 102, 242, 74, 101, 33, 205, 133, 169, 144, 127, 80, 0, 211 },
                            PasswordSalt = new byte[] { 29, 47, 11, 18, 110, 55, 81, 74, 192, 99, 233, 245, 100, 231, 47, 15, 14, 101, 73, 236, 187, 161, 95, 35, 151, 159, 158, 22, 96, 171, 108, 5, 157, 159, 113, 194, 8, 197, 75, 224, 189, 119, 28, 29, 118, 178, 95, 82, 116, 132, 252, 106, 114, 171, 6, 171, 247, 241, 249, 140, 215, 9, 92, 177, 47, 210, 121, 102, 60, 19, 60, 161, 160, 40, 119, 163, 107, 97, 184, 171, 75, 2, 255, 162, 76, 41, 142, 79, 201, 170, 233, 91, 94, 171, 223, 101, 24, 163, 237, 39, 192, 147, 252, 205, 82, 114, 194, 38, 184, 121, 55, 17, 129, 126, 91, 25, 177, 254, 145, 40, 190, 36, 99, 95, 190, 52, 172, 201 },
                            Phone = "249128647019",
                            Username = "almunzir99"
                        });
                });
