...
namespace apiplate.Controllers
{
    ...
    public class SectorsController : BaseController<Sector, SectorResource, SectorRequestResource, ISectorsService>
    {
        private readonly IRolesService _roleService;

        public SectorsController(ISectorsService service, IUriService uriService, IRolesService roleService) : base(service, uriService)
        {
