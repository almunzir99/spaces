...
namespace apiplate.Controllers
{
    ...
    public class PartnersController : BaseController<Partner, PartnerResource, PartnerRequestResource, IPartnersService>
    {
        private readonly IRolesService _roleService;

        public PartnersController(IPartnersService service, IUriService uriService, IRolesService roleService) : base(service, uriService)
        {
        ...
        protected async override Task<Permission> GetPermission(string title)
        {
            ...
            if (role != null)
                return role.PartnersPermissions;
            else
