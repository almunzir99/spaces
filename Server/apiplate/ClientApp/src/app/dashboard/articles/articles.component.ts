...
export class ArticlesComponent implements OnInit {
  ...
  constructor(private authService:AuthService,private userService:UsersService,private _service: ArticlesService,private modalService: FuiModalService) {
  ...
  openFormModal(item: Article) {
    ...
    var sub = this.userService.get().subscribe(res => {
      ...
      this.modalService.open(new FormBuilderModal(
        ...
        if (item)
          this.update(result as Article);
        else
          this.create(result as Article);
